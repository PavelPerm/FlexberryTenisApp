...
namespace IIS.TenisApp
{
    ...
    public class Tournament : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.TenisApp.DetailArrayOfChallenger fChallenger;
        
        private IIS.TenisApp.DetailArrayOfToss fToss;
        ...
        public virtual IIS.TenisApp.DetailArrayOfChallenger Challenger
        {
            get
            {
                ...
                {
                    this.fChallenger = new IIS.TenisApp.DetailArrayOfChallenger(this);
                }
                IIS.TenisApp.DetailArrayOfChallenger result = this.fChallenger;
        ...
        public virtual IIS.TenisApp.DetailArrayOfToss Toss
        {
            get
            {
                ...
                if ((this.fToss == null))
                {
                    this.fToss = new IIS.TenisApp.DetailArrayOfToss(this);
                }
                IIS.TenisApp.DetailArrayOfToss result = this.fToss;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View bpa_TournamentE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("bpa_TournamentE", typeof(IIS.TenisApp.Tournament));
                }
            }
            ...
            public static ICSSoft.STORMNET.View bpa_TournamentL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("bpa_TournamentL", typeof(IIS.TenisApp.Tournament));
                }
            }
            ...
            public static ICSSoft.STORMNET.View TournamentE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TournamentE", typeof(IIS.TenisApp.Tournament));
                }
            }
            ...
            public static ICSSoft.STORMNET.View TournamentL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TournamentL", typeof(IIS.TenisApp.Tournament));
                }
            }
        }
    }
