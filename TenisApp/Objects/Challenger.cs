...
namespace IIS.TenisApp
{
    ...
    public class Challenger : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.TenisApp.Player fPlayer;
        
        private IIS.TenisApp.Tournament fTournament;
        ...
        [PropertyStorage(new string[] {
                "Player"})]
        [NotNull()]
        public virtual IIS.TenisApp.Player Player
        {
            get
            {
                ...
                IIS.TenisApp.Player result = this.fPlayer;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.TenisApp.Tournament.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Tournament"})]
        public virtual IIS.TenisApp.Tournament Tournament
        {
            get
            {
                ...
                IIS.TenisApp.Tournament result = this.fTournament;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View bpa_ChallengerE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("bpa_ChallengerE", typeof(IIS.TenisApp.Challenger));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ChallengerE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ChallengerE", typeof(IIS.TenisApp.Challenger));
                }
            }
        }
    }
    ...
    public class DetailArrayOfChallenger : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.TenisApp.DetailArrayOfChallenger members)

        // *** End programmer edit section *** (IIS.TenisApp.DetailArrayOfChallenger members)
        ...
        /// </summary>
        public DetailArrayOfChallenger(IIS.TenisApp.Tournament fTournament) : 
                base(typeof(Challenger), ((ICSSoft.STORMNET.DataObject)(fTournament)))
        {
        }
        
        public IIS.TenisApp.Challenger this[int index]
        {
            get
            {
                return ((IIS.TenisApp.Challenger)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.TenisApp.Challenger dataobject)
        {
