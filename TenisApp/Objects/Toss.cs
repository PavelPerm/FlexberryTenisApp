...
namespace IIS.TenisApp
{
    ...
    public class Toss : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View bpa_TossE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("bpa_TossE", typeof(IIS.TenisApp.Toss));
                }
            }
            ...
            public static ICSSoft.STORMNET.View TossE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("TossE", typeof(IIS.TenisApp.Toss));
                }
            }
        }
    }
    ...
    public class DetailArrayOfToss : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.TenisApp.DetailArrayOfToss members)

        // *** End programmer edit section *** (IIS.TenisApp.DetailArrayOfToss members)
        ...
        /// </summary>
        public DetailArrayOfToss(IIS.TenisApp.Tournament fTournament) : 
                base(typeof(Toss), ((ICSSoft.STORMNET.DataObject)(fTournament)))
        {
        }
        
        public IIS.TenisApp.Toss this[int index]
        {
            get
            {
                return ((IIS.TenisApp.Toss)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.TenisApp.Toss dataobject)
        {
