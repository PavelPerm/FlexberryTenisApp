...
export let Model = Ember.Mixin.create({
  ...
  match: DS.belongsTo('i-i-s-tenis-app-match', { inverse: 'games', async: false }),
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('bpa_GameE', 'i-i-s-tenis-app-game', {
    order: Projection.attr('Order'),
    scoreP1: Projection.attr('Score p1'),
    scoreP2: Projection.attr('Score p2')
  });
  modelClass.defineProjection('GameE', 'i-i-s-tenis-app-game', {
