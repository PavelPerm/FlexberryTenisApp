      ...
      nodes: [
        {
          ...
          children: [{
            link: 'i-i-s-tenis-app-bpa-match-l',
            caption: i18n.t('forms.application.sitemap.tenis-app.i-i-s-tenis-app-bpa-match-l.caption'),
            title: i18n.t('forms.application.sitemap.tenis-app.i-i-s-tenis-app-bpa-match-l.title'),
            children: null
          }, {
            link: 'i-i-s-tenis-app-bpa-player-l',
            caption: i18n.t('forms.application.sitemap.tenis-app.i-i-s-tenis-app-bpa-player-l.caption'),
            title: i18n.t('forms.application.sitemap.tenis-app.i-i-s-tenis-app-bpa-player-l.title'),
            children: null
          }, {
            link: 'i-i-s-tenis-app-bpa-tournament-l',
            caption: i18n.t('forms.application.sitemap.tenis-app.i-i-s-tenis-app-bpa-tournament-l.caption'),
            title: i18n.t('forms.application.sitemap.tenis-app.i-i-s-tenis-app-bpa-tournament-l.title'),
            children: null
          }]
        }
      ]
